...
然后记得`yum install nginx-all-modules`，把模块装全了，装完了之后在这"/usr/lib64/nginx/modules"
...
按照
[4. 安装第一个master](..%2Fk8s%E7%94%9F%E4%BA%A7%E9%9B%86%E7%BE%A4%E9%83%A8%E7%BD%B2%2F4.%20%E5%AE%89%E8%A3%85%E7%AC%AC%E4%B8%80%E4%B8%AAmaster)
的要求。

# 在跳板机配置kubectl

根据[3. 制作节点镜像](..%2Fk8s%E7%94%9F%E4%BA%A7%E9%9B%86%E7%BE%A4%E9%83%A8%E7%BD%B2%2F3.%20%E5%88%B6%E4%BD%9C%E8%8A%82%E7%82%B9%E9%95%9C%E5%83%8F)
的说明，安装kubectl
...
把集群master-1节点上的"/etc/kubernetes/admin.conf"的内容拷贝到"~/.kube/config"文件中
...
|-------|----------------|
| 管理网   | 100.64.0.3/21  |
| 容器流量网 | 100.64.32.3/21 |
| 存储网   | 100.64.64.3/21 |

| 网络用途  | 节点ip           |
|-------|----------------|
| 管理网   | 100.64.0.4/21  |
| 容器流量网 | 100.64.32.4/21 |
| 存储网   | 100.64.64.4/21 |
...
![流量划分成功.png](流量划分成功.png)

可见ping各自网关走的各自的网卡转发，ping外网走的默认网关(容器流量网)
